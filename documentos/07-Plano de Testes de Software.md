...
|:---|:---|
| Requisitos Associados | RF-17, RF-23 |
...
| Responsável pela elaboração do caso de Teste | Kauê Alves dos Reis |
...
| Passos |Acessar a aplicação e logar; Acessar o menu no canto superior esquerdo da página (todos os menus das páginas de usuário logado contém o botão de “sair”); Clicar em “sair”; Verificar se os dados de “usuário logado” foram removidos do localStorage e se o cadastro não foi excluído; Verificar se o usuário será redirecionado para a tela de login;|
...
|Caso de Teste   | CT-08 - Testes da Página Main (Minha área) |
|:---|:---|
| Requisitos Associados | RF-06, RF-07, RF-12, RF-13, RF-16, RF-17, RF-19, RF-20, RF-23 | 
...
|:---|:---|
| Requisitos Associados | RF-06, RF-07, RF-08, RF-09, RF-12, RF-16, RF-21, RF-23 | 
...
| Responsável pela elaboração do caso de Teste | Erick Costa e Diogo Joia |

|Caso de Teste   | CT-10 - Testes das Páginas de Conteúdo |
|:---|:---|
| Requisitos Associados | RF-05, RF-23 | 
...
|:---|:---|
| Requisitos Associados | RF-15, RF-23 | 
...
|Caso de Teste   | CT-12 - Testes da Página de Perfil |
|:---|:---|
...
|Caso de Teste   | CT-13 - Testes dos Menus |
|:---|:---|
| Requisitos Associados | RF-14, RF-22 | 
...
|Caso de Teste   | CT-14 - Testes da Página de Feedback |
|:---|:---|
| Requisitos Associados | RF-18 | 
